 ...
 * 持久化到项目的 .qmai/director-room/simulations 目录下，并提供加载 / 删除 / 推演结果
 * 存取能力。
 */
...
const SIM_ROOT = ".qmai/director-room/simulations"
...
/**
 * 创建 .qmai/director-room/simulations/{frameworks,results,bindings} 目录。

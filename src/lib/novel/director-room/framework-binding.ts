...
const BINDING_FILE = ".qmai/director-room/simulations/bindings/active-binding.json"
...
export async function saveBinding(
  ...
  // createDirectory 使用 create_dir_all，会递归创建 .qmai/director-room/simulations/bindings
  await createDirectory(
    `${normalizePath(projectPath)}/.qmai/director-room/simulations/bindings`,
  )

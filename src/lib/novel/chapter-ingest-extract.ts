...
输出 JSON：
{
  ...
  "characterAppearanceAndStatus": ["角色名：外貌与衣着；当前状态"],
  "locations": [],
  "organizations": [],
  "items": [],
  "events": [],
...
规则：同一人物只进 characters 一次，昵称放入 characterAliases；characterAppearanceAndStatus 只记录正文明确出现的外貌、衣着和状态，不得推测，无信息时输出 []；无信息的 *Details 整段省略；graphEdges 关系必须是：${GRAPH_EDGE_RELATION_LABELS}。`
}
...
输出 JSON：
{
  ...
  "summary": "大纲摘要",
  "characters": [],
  "characterAppearanceAndStatus": ["人物名：明确的外貌与衣着；初始状态"],
  "locations": [],
  "organizations": [],
  "items": [],
  "events": [],

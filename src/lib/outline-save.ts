...
function extractChapterOutlineTitle(content: string): string | null {
...
function extractVolumeOutlineTitle(content: string): string | null {
...
function extractOutlineTitle(content: string): string {
  ...
  switch (contentType) {
    case "chapter-outline":
      extracted = extractChapterOutlineTitle(normalized)
      break
    case "character":
      extracted = extractCharacterTitle(normalized, lines)
      break
    case "volume-outline":
      extracted = extractVolumeOutlineTitle(normalized)
      break
    case "outline":
    case "setting":
    case "foreshadowing":

...
import type { SerializedSimulationSnapshot } from "@/lib/novel/director-room/simulation-serializer";
...
export interface DirectorRoomSimulationState {
...
export const useDirectorRoomSimulationStore = create<DirectorRoomSimulationState>((set) => ({
  phase: "idle",
  mode: "event-driven",
  userIdea: "",
  targetWords: 10000,
    ...
    for (const [id, agentState] of Object.entries(agentStates)) {
      agents.set(id, {
        ...
        relationships: new Map<
          string,
          import("@/lib/novel/director-room/types").AgentRelation
        >(),
        powerLevel: "",
        memory: {

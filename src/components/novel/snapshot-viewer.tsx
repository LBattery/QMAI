...
export function SnapshotViewer({ projectPath, chapterNumber, onClose }: SnapshotViewerProps) {
  ...
  const renderReadOnly = (data: ChapterSnapshot) => (
    <div className="space-y-2">
      ...
      <Section title={t("novel.snapshot.characterAppearanceAndStatus")} items={data.characterAppearanceAndStatus ?? []} />
  ...
  const renderEditor = (data: ChapterSnapshot) => (
    <div className="space-y-2">
      ...
      <EditableListSection title={t("novel.snapshot.characterAppearanceAndStatus")} value={data.characterAppearanceAndStatus ?? []} onChange={(value) => editList("characterAppearanceAndStatus", value)} />

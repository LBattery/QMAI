...
import { useDirectorRoomSimulationStore, type SavedSimulationResult } from "@/stores/director-room-simulation-store"
import { useWikiStore } from "@/stores/wiki-store"
import { exportReport } from "@/lib/novel/director-room/report-export"
import { cn } from "@/lib/utils"
import type { StoryBranch, TimelineEvent, StoryFramework, SimulationReport } from "@/lib/novel/director-room/types"
...
export function SimulationReportView({
  ...
  const report = useDirectorRoomSimulationStore((s) => s.currentReport)

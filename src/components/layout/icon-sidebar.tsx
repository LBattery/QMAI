...
import {
  FileText, FolderOpen, Search, Network, Brain, Settings, ArrowLeftRight, Sun, Moon, Monitor, Trash2, Sparkles, LayoutDashboard, BookOpenCheck,
} from "lucide-react"
...
const NAV_ITEMS: { view: NavView; icon: typeof FileText; labelKey: string; novelLabelKey: string }[] = [
  ...
  { view: "dismantling", icon: BookOpenCheck, labelKey: "nav.dismantling", novelLabelKey: "novel.nav.dismantling" },

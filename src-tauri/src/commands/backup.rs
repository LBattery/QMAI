...
pub async fn import_backup(
    ...
    run_guarded("import_backup", || {
        ...
        emit_progress(&app, "import", "preparing", 0, 1, "正在准备导入...");
        ...
        if need_global {
            emit_progress(&app, "import", "restoring", 0, 1, "正在恢复全局配置...");
        ...
        emit_progress(&app, "import", "done", 1, 1, "导入完成");
